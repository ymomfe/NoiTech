...
/*Heavy Oil Processor*/
const XZimurNoiseHeavyOilProcessor = extendContent(GenericCrafter, "heavy-oil-processor", {
	draw(tile){
		Draw.rect(Core.atlas.find(this.name + "-bottom"), tile.drawx(), tile.drawy());
...
/*Rock Crusher*/
const XZimurNoiseRockCrusher = extendContent(GenericCrafter, "rock-crusher", {
	draw(tile){
		Draw.rect(Core.atlas.find(this.name + "-bottom"), tile.drawx(), tile.drawy());
